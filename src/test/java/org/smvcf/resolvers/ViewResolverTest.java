...
public class ViewResolverTest {
    ...
    public void should_return_empty_string_when_given_null(){
        ...
        //assert
        assertEquals("/WEB-INF/view/index.jsp", actual);
    }

    @Test
    public void should_return_index_when_given_empty_one(){
        //act
    ...
    @Test
    public void should_return_prefix_concatenated_with_input_concatenated_with_suffix_when_given_non_empty_or_not_null_string(){
        //act
